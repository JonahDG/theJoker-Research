...
def getPlots(sources,jData,periodogramData):
    ...
    merger.write('/scratch/jdg577/theJoker/Plots/PDFs/ComparePlotsFull_488.pdf')
apogeeVisitsFile='/scratch/jdg577/theJoker/Data/allVisit-r12-l33.fits'
apogeeIDFile='/scratch/jdg577/theJoker/Data/gold_sample.fits'
...
apogeeData,sourceData=getStarData(apogeeVisitsFile,tessFile,tessMetaDataFile)
